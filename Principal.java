public class Principal{
    ...
    public static void main(String args[]){
        ...
        Disciplina disciplina2 = new Disciplina("Queijo", 60);
        ...
        Curso curso = new Curso("SI");
        
        System.out.println("Carga horaria: " + curso.horasTotaisCurso());

        curso.addDiciplina(disciplina);
        curso.addDiciplina(disciplina2);
